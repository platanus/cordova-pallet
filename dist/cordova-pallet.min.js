...
!function(){function e(e,a,l){function o(e,o,n,t){function r(){return e.buttonLabel||"Select file..."}function i(){return!t.$viewValue}function c(){(e.removeCallback||angular.noop)(),g(null)}function u(a){var l=JSON.parse(a.response),o=l.upload||l,n={localFileName:m,loaded:1,total:1};g(o.identifier),o.localFileName=m,(e.progressCallback||angular.noop)({event:n}),(e.successCallback||angular.noop)({uploadData:o})}function p(a){var l={localFileName:m,loaded:1,total:1},o={localFileName:m,error:a.exception,status:a.http_status};(e.progressCallback||angular.noop)({event:l}),(e.errorCallback||angular.noop)({errorData:o})}function s(a){var l={localFileName:m,loaded:.95*a.loaded,total:a.total};(e.progressCallback||angular.noop)({event:l})}function d(){g(null),(e.initCallback||angular.noop)()}function g(e){return e?void t.$setViewValue(e):void t.$setViewValue(null)}function v(){var o={destinationType:Camera.DestinationType.FILE_URI,sourceType:Camera.PictureSourceType.PHOTOLIBRARY,encodingType:Camera.EncodingType.JPEG};l.getPicture(o).then(function(l){d(),a.upload(e.uploadUrl,l,{mimeType:"image/jpeg",fileName:m}).then(u,p,s)})}var m="image.jpg";e.onUploadButtonClick=v,e.getButtonLabel=r,e.onRemoveUpload=c,e.emptyIdentifier=i}var n={template:'<div class="pallet-file-selector"><div class="upload-btn" ng-click="onUploadButtonClick()"> <button>{{ getButtonLabel() }}</button> </div><img class="remove-btn" ng-src="{{ trashIcon }}" ng-click="onRemoveUpload()" ng-hide="emptyIdentifier()" /></div>',require:"ngModel",scope:{uploadUrl:"@",buttonLabel:"@",initCallback:"&",successCallback:"&",progressCallback:"&",errorCallback:"&",removeCallback:"&",doneCallback:"&"},link:o};return n}angular.module("platanus.cordovaPallet").directive("palletFileSelector",e),e.$inject=["trashIcon","$cordovaFileTransfer","$cordovaCamera"]}();